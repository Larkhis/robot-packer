...
Technologies: [Java](https://www.java.com/) - [Maven](https://maven.apache.org/) - [JUnit](http://junit.org/) - [LOG4J](https://logging.apache.org/) - [Git](https://git-scm.com/)

### Génération du .jar ###
```
mvn clean install
```
Cette commande génère l'executable **robot-packer***.jar** dans le dossier /target.

### Exécution ###
```
java -jar target/robot-packer-jar-with-dependencies.jar [articles]
```
Si aucun argument fourni, la chaine d'article 163841689525773 est prise par défaut.
